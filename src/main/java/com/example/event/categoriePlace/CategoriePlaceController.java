...
@Controller
@RequestMapping(value = "categoriePlace")
public class CategoriePlaceController {
    ...
    public ModelAndView createe(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            CategoriePlace obj = new CategoriePlace();
            obj.setFieldsVal(request.getParameterMap(), false, "");
            CategoriePlaceService.create(obj, null);
    ...
    public ModelAndView updatee(@PathVariable("id") String id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            obj.setIdCategoriePlace(id);
            CategoriePlaceService.update(obj, null);
    ...
    public ModelAndView deletee(@PathVariable("id") String id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            CategoriePlace obj = new CategoriePlace();
            obj.setIdCategoriePlace(id);
            CategoriePlaceService.delete(obj, null);
    ...
    @RequestMapping("/generalCategoriePlace")
    public ModelAndView pagegeneralcategoriePlace(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = new ModelAndView();
        try {
            String sql = "select * from CategoriePlace where 1<2 ";
            CategoriePlace objfiltre = new CategoriePlace();
            ...
            ArrayList list = new CategoriePlace().select(null, sql);

            mv.addObject("list", list);
            mv.addObject("objfiltre", objfiltre);
            mv.addObject("searchform", form);

            String but = "views/general/generalCategoriePlace.jsp";
