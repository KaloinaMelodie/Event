...
@Controller
@RequestMapping(value = "uniteTarif")
public class UniteTarifController {
    ...
    public ModelAndView createe(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            UniteTarif obj = new UniteTarif();
            obj.setFieldsVal(request.getParameterMap(), false, "");
            UniteTarifService.create(obj, null);
    ...
    public ModelAndView updatee(@PathVariable("id") int id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            obj.setIdUniteTarif(id);
            UniteTarifService.update(obj, null);
    ...
    public ModelAndView deletee(@PathVariable("id") int id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            UniteTarif obj = new UniteTarif();
            obj.setIdUniteTarif(id);
            UniteTarifService.delete(obj, null);
    ...
    @RequestMapping("/generalUniteTarif")
    public ModelAndView pagegeneraluniteTarif(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = new ModelAndView();
        try {
            String sql = "select * from UniteTarif where 1<2 ";
            UniteTarif objfiltre = new UniteTarif();
            ...
            ArrayList list = new UniteTarif().select(null, sql);

            mv.addObject("list", list);
            mv.addObject("objfiltre", objfiltre);
            mv.addObject("searchform", form);

            String but = "views/general/generalUniteTarif.jsp";
