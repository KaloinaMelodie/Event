...
@Controller
@RequestMapping(value = "typePrestation")
public class TypePrestationController {
    ...
    public ModelAndView createe(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            TypePrestation obj = new TypePrestation();
            obj.setFieldsVal(request.getParameterMap(), false, "");
            TypePrestationService.create(obj, null);
    ...
    public ModelAndView updatee(@PathVariable("id") String id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            obj.setIdTypePrestation(id);
            TypePrestationService.update(obj, null);
    ...
    public ModelAndView deletee(@PathVariable("id") String id, HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            TypePrestation obj = new TypePrestation();
            obj.setIdTypePrestation(id);
            TypePrestationService.delete(obj, null);
    ...
    @RequestMapping("/generalTypePrestation")
    public ModelAndView pagegeneraltypePrestation(HttpSession session, HttpServletRequest request, HttpServletResponse response) {
        ModelAndView mv = new ModelAndView();
        try {
            String sql = "select * from TypePrestation where 1<2 ";
            TypePrestation objfiltre = new TypePrestation();
            ...
            ArrayList list = new TypePrestation().select(null, sql);

            mv.addObject("list", list);
            mv.addObject("objfiltre", objfiltre);
            mv.addObject("searchform", form);

            String but = "views/general/generalTypePrestation.jsp";
