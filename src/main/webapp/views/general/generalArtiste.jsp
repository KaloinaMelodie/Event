        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/artiste/create.do" enctype="multipart/form-data" method="POST">
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/artiste/generalArtiste.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        V_artiste cast = (V_artiste) obj;
                                        Artiste mod = new Artiste();
                                        mod.setIdArtiste(cast.getIdArtiste());
                                        mod = (Artiste) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdArtiste().toString());
...
%>
                                <tr>
                                    <td><%= cast.getIdArtiste()%></td>
                                    <td><%= cast.getNomArtiste()%></td>
                                    <td><%= Base.formatD(cast.getTarifArtiste())%></td>
                                    <td><%= cast.getUniteTarif()%></td>
                                    <td><%= Base.formatD(cast.getEnHeure())%></td>
                                    <td><img src="data:image/png;base64,<%= cast.getPhotoArtiste()%>" alt="" style="width:100px;height:50px"></td>


                                    <td>
                                        <button type="button" class="btn btn-default "
                                                data-bs-toggle="modal" data-bs-target="#modifModal<%= cast.getIdArtiste()%>">
                                            <i class="fa fa-edit"></i> 
                                        </button>
                                        <div class="modal" id="modifModal<%= cast.getIdArtiste()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form  method="POST" action="/Event/artiste/update/<%= cast.getIdArtiste()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/artiste/delete/<%= cast.getIdArtiste()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
