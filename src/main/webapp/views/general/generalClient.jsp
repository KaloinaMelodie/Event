        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/client/create.do" method="POST" >
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/client/generalClient.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
...
<th>email</th>
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        Client cast = (Client) obj;
                                        Client mod = new Client();
                                        mod.setIdClient(cast.getIdClient());
                                        mod = (Client) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdClient().toString());
                                ...
                                %>
                                <tr>
                                    <td><%= cast.getIdClient() %></td>
<td><%= cast.getIntitule() %></td>
<td><%= cast.getContact() %></td>
<td><%= cast.getAdresse() %></td>
<td><%= cast.getEmail() %></td>


                                    <td>
                                        <button type="button" class="btn btn-default "
                                                data-bs-toggle="modal" data-bs-target="#modifModal<%= cast.getIdClient()%>">
                                            <i class="fa fa-edit"></i> 
                                        </button>
                                        <div class="modal" id="modifModal<%= cast.getIdClient()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form  method="POST" action="/Event/client/update/<%= cast.getIdClient()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/client/delete/<%= cast.getIdClient()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
