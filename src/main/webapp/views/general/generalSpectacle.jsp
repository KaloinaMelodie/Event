...
<%@page import="com.example.event.spectacle.Spectacle"%>
...
<%
    Spectacle object = new Spectacle();
    String error = null;
        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/spectacle/create.do" method="POST">
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/spectacle/generalSpectacle.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
...
<th>dateHeure</th>
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        Spectacle cast = (Spectacle) obj;
                                        Spectacle mod = new Spectacle();
                                        mod.setIdSpectacle(cast.getIdSpectacle());
                                        mod = (Spectacle) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdSpectacle().toString());
                                ...
                                %>
                                <tr>
                                    <td><%= cast.getIdSpectacle() %></td>
<td><%= cast.getTitre() %></td>
<td><%= cast.getDateHeure() %></td>


                                    <td>
                                        <button type="button" class="btn btn-default "
                                                data-bs-toggle="modal" data-bs-target="#modifModal<%= cast.getIdSpectacle()%>">
                                            <i class="fa fa-edit"></i> 
                                        </button>
                                        <div class="modal" id="modifModal<%= cast.getIdSpectacle()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form  method="POST" action="/Event/spectacle/update/<%= cast.getIdSpectacle()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/spectacle/delete/<%= cast.getIdSpectacle()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
