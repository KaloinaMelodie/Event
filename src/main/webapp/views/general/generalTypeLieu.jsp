...
<%@page import="com.example.event.typeLieu.TypeLieu"%>
        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/typeLieu/create.do" method="POST">
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/typeLieu/generalTypeLieu.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
                ...
                <div class="box">
                    <div class="box-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        TypeLieu cast = (TypeLieu) obj;
                                        TypeLieu mod = new TypeLieu();
                                        mod.setIdTypeLieu(cast.getIdTypeLieu());
                                        mod = (TypeLieu) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdTypeLieu().toString());
...
%>
                                <tr>
                                    ...
                                    <td><%= cast.getTypeLieu()%></td>


                                    <td>
                                        <button type="button" class="btn btn-default "
                                                data-bs-toggle="modal" data-bs-target="#modifModal<%= cast.getIdTypeLieu()%>">
                                            <i class="fa fa-edit"></i> 
                                        </button>
                                        <div class="modal" id="modifModal<%= cast.getIdTypeLieu()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form  method="POST" action="/Event/typeLieu/update/<%= cast.getIdTypeLieu()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/typeLieu/delete/<%= cast.getIdTypeLieu()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
