        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/devis/create.do" method="POST">
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/devis/generalDevis.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        ...
                                        Devis mod = new Devis();
                                        mod.setIdDevis(cast.getIdDevis());
                                        mod = (Devis) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdDevis().toString());
...
%>
                                <tr>
                                        ...
                                        <div class="modal" id="modifModal<%= cast.getIdDevis()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form  method="POST" action="/Event/devis/update/<%= cast.getIdDevis()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/devis/delete/<%= cast.getIdDevis()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
