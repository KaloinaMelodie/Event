...
<%@page import="com.example.event.taxe.Taxe"%>
        ...
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="modal" id="insertModal" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="/Event/taxe/create.do" method="POST">
                ...
                <div class="box collapsed-box">
                    ...
                    <form role="form" action="/Event/taxe/generalTaxe.do" method="POST">
                        <div class="box-body">
                            <div class="row">
                                <%= form.getHtml()%>
                            </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                <%for (Object obj : list) {
                                        Taxe cast = (Taxe) obj;
                                        Taxe mod = new Taxe();
                                        mod.setIdTaxe(cast.getIdTaxe());
                                        mod = (Taxe) mod.select(null, null).get(0);
                                        Form modifform = new Form(mod, null);
                                        modifform.setModifmode(true);
                                        modifform.setPrefix(cast.getIdTaxe().toString());
...
%>
                                <tr>
                                    <td><%= cast.getIdTaxe()%></td>
                                    <td><%= Base.formatD(cast.getPourc())%></td>


                                    <td>
                                        <button type="button" class="btn btn-default "
                                                data-bs-toggle="modal" data-bs-target="#modifModal<%= cast.getIdTaxe()%>">
                                            <i class="fa fa-edit"></i> 
                                        </button>
                                        <div class="modal" id="modifModal<%= cast.getIdTaxe()%>" tabindex="-1">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <form  method="POST" action="/Event/taxe/update/<%= cast.getIdTaxe()%>.do">                                                        
                                                        <div class="modal-body ">
                                                            <%= modifform.getHtml()%>
                                                        </div>
                                    ...
                                    <td><a class="btn btn-default" onclick="return confirmLink();" href="/Event/taxe/delete/<%= cast.getIdTaxe()%>.do"><i class="fa fa-trash-o"></i>
                                        </a></td>
                                </tr>
                                <%}%>
                            </tbody>
